...
public class MainBTC
{
	...
	GpioPinDigitalInput resetButton = gpio.provisionDigitalInputPin(
	    RaspiPin.GPIO_07, PinPullResistance.PULL_UP);
	...
	GpioPinDigitalInput dsButton = gpio.provisionDigitalInputPin(
	    RaspiPin.GPIO_14, PinPullResistance.PULL_UP);
	...
	private void showBtc(Max7219Driver driver, int maxIntensity)
	    throws Exception
	{
	...
	private void showShahar(Max7219Driver driver, int intensity)
	    throws Exception
	{
	driver.sendTwice(Max7219Address.INTENSITY, intensity);
	...
	private void showHallel(Max7219Driver driver, int intensity)
	    throws Exception
	{
	driver.sendTwice(Max7219Address.INTENSITY, intensity);
